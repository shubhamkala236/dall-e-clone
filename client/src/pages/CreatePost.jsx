...
const CreatePost = () => {
  ...
  // generateImage calls our backend
  ...
  const handleSubmit = async(e)=>{
    ...
    if(form.prompt && form.photo){
      ...
      alert('Please enter prompt to generate an image')
    }
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      ...
      <div className='mt-10'>
        <p className='mt-2 text-[#666e75] text-[14px]'> Once you have created the image you want, you can share with community</p>
        <button
          type='submit'
          className='mt-3 text-white bg-[#6469ff] font-medium rounded-md text-sm w-full sm:w-auto [x-5 py-2.5 text-center'
        >
